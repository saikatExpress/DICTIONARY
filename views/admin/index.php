...
<head>
    ...
    <!-- General CSS Files -->
    <link rel="stylesheet" href="../../public/othikaassets/css/app.min.css">
    <!-- Template CSS -->
    <link rel="stylesheet" href="../../public/othikaassets/css/style.css">
    <link rel="stylesheet" href="../../public/othikaassets/css/components.css">
    <!-- Custom style CSS -->
    <link rel="stylesheet" href="../../public/othikaassets/css/custom.css">
    <link rel='shortcut icon' type='image/x-icon' href='../../public/othikaassets/img/favicon.ico' />
</head>
...
<body>
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="../../views/admin/customer/index.php">Customer</a></li>
    ...
    <!-- General JS Scripts -->
    <script src="../../public/othikaassets/js/app.min.js"></script>
    <!-- JS Libraies -->
    <script src="../../public/othikaassets/bundles/apexcharts/apexcharts.min.js"></script>
    <!-- Page Specific JS File -->
    <script src="../../public/othikaassets/js/page/index.js"></script>
    <!-- Template JS File -->
    <script src="../../public/othikaassets/js/scripts.js"></script>
    <!-- Custom JS File -->
    <script src="../../public/othikaassets/js/custom.js"></script>
</body>
